...
class LabeledDataset(torch.utils.data.Dataset):    
    ...
    def __getitem__(self, index):
        ...
        # CUSTOM CODE
        x_corners = (data_entries[['fl_x', 'fr_x', 'bl_x', 'br_x']].to_numpy() + 40)/ 0.1
        y_corners = (data_entries[['fl_y', 'fr_y', 'bl_y', 'br_y']].to_numpy() + 40)/0.1
        ...
        bboxes = np.stack((x_min_corn,y_min_corn,x_max_corn,y_max_corn),axis=1)
